...
% source: Kutz, J. Nathan, et al. Dynamic mode decomposition: data-driven modeling of complex systems. Society for Industrial and Applied Mathematics, 2016.
...
[W_r, D] = eig(Atilde);  % eigendecomposition of Atilde
Phi = X2 * V_r / S_r * W_r;  %DMD modes

lambda = diag(D);  % discrete-time eigenvalues
omega = log(lambda)/dt;  %continuous-time eigenvalues

%% Compute DMD model amplitudes
x1 = X1(:, 1);
b = phi\x1;
